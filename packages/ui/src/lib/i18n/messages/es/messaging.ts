export const messagingMessages = {
  ...
  "promptQueue.refused.quota": "El almacenamiento local rechazó la escritura, así que el prompt no se encoló. Tu texto sigue en el editor. Vacía algunos elementos e inténtalo de nuevo.",
