export const settingsMessages = {
  ...
  "settings.google.subtitle": "Gemini Developer API y Antigravity son proveedores independientes con facturación y cuota separadas.",
  ...
  "settings.google.status.auth_required": "AUTENTICACIÓN REQUERIDA",
  ...
  "settings.google.antigravityRisk.caption": "Integración experimental. Usa un adaptador de OpenCode de la comunidad y puede estar sujeta a las restricciones de servicio de Google.",
  "settings.google.acknowledge": "Entendido",
  "settings.google.fallback.title": "Permitir respaldo entre proveedores",
  "settings.google.fallback.caption": "Si se activa, un proveedor agotado puede enrutarse al otro grupo de Google. Desactivado por defecto para que un error de cuota nunca gaste créditos pagados en silencio.",
} as const
