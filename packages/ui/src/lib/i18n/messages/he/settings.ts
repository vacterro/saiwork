export const settingsMessages = {
  ...
  "settings.google.subtitle": "Gemini Developer API ו-Antigravity הם ספקים בלתי תלויים עם חיוב ומכסה נפרדים.",
  "settings.google.refresh": "רענן",
  "settings.google.loading": "בודק מצב ספק...",
  "settings.google.experimental": "ניסיוני",
  "settings.google.official": "רשמי",
  "settings.google.models": "מודלים",
  "settings.google.status.ready": "מוכן",
  "settings.google.status.auth_required": "נדרש התחברות",
  "settings.google.status.not_configured": "לא מוגדר",
  "settings.google.status.plugin_missing": "המתאם חסר",
  "settings.google.status.unavailable": "לא זמין",
  "settings.google.antigravityRisk.title": "Antigravity הוא ניסיוני",
  "settings.google.antigravityRisk.caption": "אינטגרציה ניסיונית. משתמשת במתאם OpenCode קהלתי ועשויה להיות כפופה להגבלות השירות של Google.",
  "settings.google.acknowledge": "הבנתי",
  "settings.google.fallback.title": "אפשר מעבר בין ספקים",
  "settings.google.fallback.caption": "אם מופעל, ספק מדולל עשוי לנתב למאגר Google האחר. כבוי ברירת מחדל כדי ששגיאת מכסה לא תבזבז בשקט אשראי משולמים.",
} as const
