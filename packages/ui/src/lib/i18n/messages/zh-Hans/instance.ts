export const instanceMessages = {
  "instanceTabs.scrollLeft.ariaLabel": "向左滚动标签页",
  "instanceTabs.scrollRight.ariaLabel": "向右滚动标签页",
  "instanceTabs.more.ariaLabel": "更多项目标签页",
  ...
  "instanceShell.metrics.availableLabel": "剩余",
  "instanceShell.metrics.compactionLabel": "压缩",
  ...
  "instanceShell.rightPanel.modules.core": "SAIWORK 核心",
  ...
  "freebuff.engine.title": "引擎",
  "freebuff.engine.notFound": "未找到 FreeBuff Desktop。请安装或设置 SAIWORK_FREEBUFF_HOME。",
  "freebuff.engine.ready": "就绪",
  "freebuff.engine.stopped": "已停止",
  "freebuff.engine.start": "启动引擎",
  "freebuff.engine.starting": "启动中...",
  "freebuff.quota.exhausted": "已用尽",
  "freebuff.threads.refresh": "刷新",
  "freebuff.threads.model": "模型",
  "freebuff.threads.titleLabel": "标题",
  "freebuff.threads.titlePlaceholder": "线程标题（可选）",
  "freebuff.threads.none": "暂无线程。",
  "freebuff.turn.running": "执行中...",
  "freebuff.turn.disabledReason": "请等待当前回合结束。",
  "freebuff.turn.user": "你",
  "freebuff.turn.agent": "代理",
  "freebuff.engine.stop": "停止引擎",
  "freebuff.quota.title": "每日配额",
  "freebuff.quota.tier": "层级: {tier}",
  "freebuff.quota.resetAt": "重置时间 {time}",
  "freebuff.threads.title": "线程",
  "freebuff.threads.count": "{count} 个线程",
  "freebuff.threads.new": "新建线程",
  "freebuff.threads.engineNeeded": "启动引擎以使用 FreeBuff。",
  "freebuff.turn.title": "回合",
  "freebuff.turn.stop": "停止回合",
  "freebuff.turn.empty": "尚无输出。",
  "freebuff.turn.composerPlaceholder": "向 FreeBuff 代理发指令",
  "freebuff.turn.send": "发送",
  "freebuff.turn.clear": "清除输出",
  "freebuff.turn.tool": "工具",
  ...
  "instanceShell.worktree.delete.error.summary.inUse": "SAIWORK 无法删除这个 worktree，因为目录中的文件仍在被某些进程使用。",
  "instanceShell.worktree.delete.error.summary.notFound": "SAIWORK 无法删除这个 worktree，因为目录或 worktree 记录未找到。",
  "instanceShell.worktree.delete.error.summary.permissionDenied": "SAIWORK 无法删除这个 worktree，因为目录访问被拒绝。",
  "instanceShell.worktree.delete.error.summary.unknown": "SAIWORK 无法删除这个 worktree。",
