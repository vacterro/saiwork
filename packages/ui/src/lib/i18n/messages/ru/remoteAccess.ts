export const remoteAccessMessages = {
  ...
  "remoteAccess.title": "Подключитесь к SAIWORK удаленно",
  "remoteAccess.subtitle": "Используйте адреса ниже, чтобы открыть SAIWORK с другого устройства.",
  ...
  "remoteAccess.address.scope.loopback": "Локальный loopback",
