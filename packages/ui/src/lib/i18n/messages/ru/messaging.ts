export const messagingMessages = {
  ...
  "saipenView.conflict": "Файл SAIPEN изменён извне. Ваш черновик НЕ записан.",
  "saipenView.conflictReload": "Перезагрузить текущий",
  "saipenView.conflictKeepDraft": "Сохранить черновик",
  "saipenView.externalChanged": "Файл SAIPEN изменён извне. Ваш черновик сохранён; перезагрузите, чтобы продолжить.",
  ...
  "saipen.subs.package.ready.short": "Готов",
  "saipen.subs.package.pending.short": "Ждёт",
  "saipen.subs.queue.short": "Очередь",
  ...
  "promptQueue.refused.quota": "Не удалось поставить промпт в очередь. Текст остался в редакторе — попробуй ещё раз.",
  "promptQueue.recoveryFailed": "Промпт не был отправлен и не восстановился в очереди. Скопируй его из этого окна перед закрытием.",
  "promptQueue.refused.conflict": "Очередь изменилась в другом окне. Текст остался в редакторе — попробуй ещё раз.",
