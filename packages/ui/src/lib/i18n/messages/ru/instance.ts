export const instanceMessages = {
  "instanceTabs.scrollLeft.ariaLabel": "Прокрутить вкладки влево",
  "instanceTabs.scrollRight.ariaLabel": "Прокрутить вкладки вправо",
  "instanceTabs.more.ariaLabel": "Другие вкладки проектов",
  ...
  "instanceShell.metrics.availableLabel": "Осталось",
  "instanceShell.metrics.compactionLabel": "Сжатие",
  "instanceShell.metrics.limitLabel": "Лимит",
  ...
  "instanceShell.rightPanel.modules.core": "Ядро SAIWORK",
  ...
  "freebuff.engine.title": "Движок",
  "freebuff.engine.notFound": "FreeBuff Desktop не найден. Установите его или задайте SAIWORK_FREEBUFF_HOME.",
  "freebuff.engine.ready": "Готов",
  "freebuff.engine.stopped": "Остановлен",
  "freebuff.engine.start": "Запустить движок",
  "freebuff.engine.starting": "Запуск...",
  "freebuff.quota.exhausted": "израсходовано",
  "freebuff.threads.refresh": "Обновить",
  "freebuff.threads.model": "Модель",
  "freebuff.threads.titleLabel": "Название",
  "freebuff.threads.titlePlaceholder": "Название потока (необязательно)",
  "freebuff.threads.none": "Потоков пока нет.",
  "freebuff.turn.running": "Выполняется...",
  "freebuff.turn.disabledReason": "Дождитесь завершения текущего хода.",
  "freebuff.turn.user": "Вы",
  "freebuff.turn.agent": "Агент",
  "freebuff.engine.stop": "Остановить движок",
  "freebuff.quota.title": "Дневная квота",
  "freebuff.quota.tier": "Уровень: {tier}",
  "freebuff.quota.resetAt": "сброс {time}",
  "freebuff.threads.title": "Потоки",
  "freebuff.threads.count": "{count} потоков",
  "freebuff.threads.new": "Новый поток",
  "freebuff.threads.engineNeeded": "Запустите движок, чтобы использовать FreeBuff.",
  "freebuff.turn.title": "Ход",
  "freebuff.turn.stop": "Остановить ход",
  "freebuff.turn.empty": "Вывода пока нет.",
  "freebuff.turn.composerPlaceholder": "Запрос агенту FreeBuff",
  "freebuff.turn.send": "Отправить",
  "freebuff.turn.clear": "Очистить вывод",
  "freebuff.turn.tool": "Инструмент",
  ...
  "instanceShell.worktree.delete.error.summary.inUse": "SAIWORK не смог удалить этот worktree, потому что что-то все еще использует файлы в каталоге.",
  "instanceShell.worktree.delete.error.summary.notFound": "SAIWORK не смог удалить этот worktree, потому что каталог или запись worktree не найдены.",
  "instanceShell.worktree.delete.error.summary.permissionDenied": "SAIWORK не смог удалить этот worktree, потому что доступ к каталогу был запрещен.",
  "instanceShell.worktree.delete.error.summary.unknown": "SAIWORK не смог удалить этот worktree.",
