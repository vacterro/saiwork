export const messagingMessages = {
  ...
  "promptQueue.refused.quota": "Le stockage local a refusé l'écriture, le prompt n'a pas été mis en file. Ton texte est toujours dans l'éditeur. Vide quelques entrées et réessaie.",
