export const settingsMessages = {
  ...
  "settings.hideMenuBar.subtitle": "Retirer la barre de menu (Fichier/Édition/Affichage/Fenêtre). Appliqué immédiatement.",
  "settings.nav.saipen": "SAIPEN",
  "settings.nav.window": "Fenêtre",
  "settings.window.title": "Presets de fenêtre",
  "settings.window.subtitle": "Dispositions sur lesquelles Ctrl+Q aligne la fenêtre active. Créez, modifiez ou supprimez des presets ; l'actif est appliqué.",
  "settings.window.none": "Aucun preset. Ajoutez-en un pour que Ctrl+Q ait quelque chose à aligner.",
  ...
  "settings.window.centered": " · centré",
  "settings.window.at": " à {x},{y}",
  ...
  "settings.behavior.queueEnabled.subtitle": "Empilez les prompts pendant que l'agent travaille. Chaque prompt en file d'attente est envoyé automatiquement lorsque la session devient inactive.",
  ...
  "settings.saipen.autoUpdate.title": "Mise à jour automatique du protocole",
  "settings.saipen.autoUpdate.subtitle": "Mettre à jour le protocole SAIPEN par git-pull périodiquement. Désactivé par défaut ; seulement si le home est un dépôt git.",
  ...
  "settings.saipen.enabled.subtitle": "Injecte les fichiers de démarrage et de style SAIPEN dans les sessions OpenCode.",
  "settings.saipen.home.title": "Dossier SAIPEN",
  "settings.saipen.home.autoDetect": "Détection depuis l'état du projet, l'environnement ou le dossier utilisateur.",
  "settings.saipen.home.placeholder": "V:\\chemin\\vers\\SAIPEN",
  "settings.saipen.files.title": "Fichiers d'instructions",
  "settings.saipen.files.default": "Par défaut : BOOT.md, STYLE.md",
  ...
  "settings.saipen.saveError": "Impossible d'enregistrer les paramètres SAIPEN : {error}",
  ...
  "settings.google.subtitle": "Gemini Developer API et Antigravity sont des fournisseurs indépendants avec facturation et quota séparés.",
  "settings.google.refresh": "Actualiser",
  "settings.google.loading": "Vérification de l'état du fournisseur...",
  "settings.google.experimental": "Expérimental",
  "settings.google.official": "Officiel",
  "settings.google.models": "modèles",
  "settings.google.status.ready": "PRÊT",
  "settings.google.status.auth_required": "AUTH REQUISE",
  "settings.google.status.not_configured": "NON CONFIGURÉ",
  "settings.google.status.plugin_missing": "ADAPTATEUR MANQUANT",
  "settings.google.status.unavailable": "INDISPONIBLE",
  "settings.google.antigravityRisk.title": "Antigravity est expérimental",
  "settings.google.antigravityRisk.caption": "Intégration expérimentale. Utilise un adaptateur OpenCode communautaire et peut être soumise aux restrictions de service de Google.",
  "settings.google.acknowledge": "Compris",
  "settings.google.fallback.title": "Autoriser le basculement entre fournisseurs",
  "settings.google.fallback.caption": "Si activé, un fournisseur épuisé peut router vers l'autre pool Google. Désactivé par défaut afin qu'une erreur de quota ne dépense jamais silencieusement des crédits payés.",
} as const
