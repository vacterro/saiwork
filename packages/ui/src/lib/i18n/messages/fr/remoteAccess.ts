export const remoteAccessMessages = {
  ...
  "remoteAccess.title": "Se connecter à SAIWORK à distance",
  "remoteAccess.subtitle": "Utilisez les adresses ci-dessous pour ouvrir SAIWORK depuis un autre appareil.",
