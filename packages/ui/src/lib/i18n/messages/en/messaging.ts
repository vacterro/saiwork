export const messagingMessages = {
  ...
  "promptInput.overlay.attachments": "вЂў {count} file(s) attached",
  ...
  "saipenView.conflict": "SAIPEN file changed externally. Your draft was NOT written.",
  "saipenView.conflictReload": "Reload current",
  ...
  "saipen.subs.package.ready.short": "Ready",
  "saipen.subs.package.pending.short": "Wait",
  "saipen.subs.queue.short": "Queue",
  ...
  "saipen.goalAuto.blockedByQuotaHint": "On, but the daily quota for this model is exhausted. Goal Auto resumes when the quota resets.",
  "saipen.goalAuto.onWaitHint": "On, but the project is waiting on you (next_action is WAIT). Triage the blocked items and Goal Auto resumes.",
  "freebuff.switchDialog.title": "Switch FreeBuff tab",
  "freebuff.switchDialog.message": "FreeBuff allows one tab at a time. Close the current FreeBuff tab and start a new FreeBuff session in this dialog?",
  "freebuff.switchDialog.confirm": "Switch",
  "freebuff.switchDialog.cancel": "Cancel",
  ...
  "promptQueue.refused.quota": "The prompt could not be queued. Your text is still in the editor вЂ” try again.",
  ...
  "promptQueue.refused.conflict": "The queue changed in another window. Your text is still in the editor вЂ” try again.",
