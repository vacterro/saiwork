export const settingsMessages = {
  ...
  "modelSelector.quota.exhausted": "No quota today В· resets {time}",
  "modelSelector.quota.exhaustedNoReset": "No quota today",
  "modelQuota.sendBlocked.title": "Daily quota exhausted for {model}",
  "modelQuota.sendBlocked.message": "No daily quota left today. It resets at {time}. Send anyway?",
  "modelQuota.sendBlocked.confirm": "Send anyway",
  "modelQuota.sendBlocked.cancel": "Cancel",
  ...
  "providerUsage.windows.sevenDaysSonnet": "7 days В· Sonnet",
  "providerUsage.windows.sevenDaysOpus": "7 days В· Opus",
  ...
  "settings.hideMenuBar.title": "Hide menu bar",
  "settings.hideMenuBar.subtitle": "Remove the File/Edit/View/Window menu bar from the window. Applies immediately.",
  "settings.nav.saipen": "SAIPEN",
  "settings.nav.window": "Window",
  "settings.window.title": "Window presets",
  "settings.window.subtitle": "Layouts Ctrl+Q snaps the active window to. Create, edit, or delete presets; the active one is applied.",
  "settings.window.none": "No presets yet. Add one to give Ctrl+Q something to snap to.",
  "settings.window.add": "Add preset",
  "settings.window.delete": "Delete",
  "settings.window.use": "Use",
  "settings.window.active": "Active",
  "settings.window.centered": " В· centered",
  "settings.window.at": " at {x},{y}",
  "settings.window.preset.defaultName": "New preset",
  "settings.window.preset.name": "Name",
  "settings.window.preset.width": "Width",
  "settings.window.preset.height": "Height",
  "settings.window.preset.x": "X",
  "settings.window.preset.y": "Y",
  "settings.nav.info": "Info",
  "settings.scope.device": "This device",
  "settings.shortcuts.title": "Keyboard shortcuts",
  "settings.shortcuts.subtitle": "Rebind SAIWORK shortcuts. Click a binding, then press the new key combination.",
  "settings.shortcuts.saipenBar": "Toggle SAIPEN bar",
  ...
  "settings.behavior.queueEnabled.title": "Prompt queue",
  "settings.behavior.queueEnabled.subtitle": "Stack prompts while the agent is working. Each queued prompt is sent automatically when the session goes idle.",
  ...
  "settings.saipen.subtitle": "Configure protocol injection for every agent session.",
  "settings.saipen.enabled.title": "Enable SAIPEN",
  "settings.saipen.enabled.subtitle": "Inject the live SAIPEN boot and style files into OpenCode sessions.",
  "settings.saipen.autoUpdate.title": "Auto-update protocol",
  "settings.saipen.autoUpdate.subtitle": "Git-pull the SAIPEN protocol home periodically. Off by default; only runs when the home is a git repository.",
  "settings.saipen.home.title": "SAIPEN home",
  "settings.saipen.home.autoDetect": "Auto-detect from project state, environment, or user home.",
  "settings.saipen.home.placeholder": "V:\\path\\to\\SAIPEN",
  "settings.saipen.files.title": "Instruction files",
  "settings.saipen.files.default": "Default: BOOT.md, STYLE.md",
  "settings.saipen.files.placeholder": "BOOT.md, STYLE.md",
  "settings.saipen.edit": "Edit",
  "settings.saipen.save": "Save",
  "settings.saipen.cancel": "Cancel",
  "settings.saipen.saveError": "Could not save SAIPEN settings: {error}",
  ...
  "settings.speech.testInput.requesting": "StartingвЂ¦",
  ...
  "settings.google.subtitle": "Gemini Developer API and Antigravity are independent providers with separate billing and quota.",
  "settings.google.refresh": "Refresh",
  "settings.google.loading": "Checking provider status...",
  "settings.google.experimental": "Experimental",
  "settings.google.official": "Official",
  "settings.google.models": "models",
  "settings.google.status.ready": "READY",
  "settings.google.status.auth_required": "AUTH REQUIRED",
  "settings.google.status.not_configured": "NOT CONFIGURED",
  "settings.google.status.plugin_missing": "ADAPTER MISSING",
  "settings.google.status.unavailable": "UNAVAILABLE",
  "settings.google.antigravityRisk.title": "Antigravity is experimental",
  "settings.google.antigravityRisk.caption": "Experimental integration. Uses a community OpenCode adapter and may be subject to Google's service restrictions.",
  "settings.google.acknowledge": "I understand",
  "settings.google.fallback.title": "Allow cross-provider fallback",
  "settings.google.fallback.caption": "If enabled, an exhausted provider may route to the other Google pool. Off by default so a quota error can never silently start spending paid credits.",
} as const
