export const instanceMessages = {
  ...
  "instanceTabs.more.ariaLabel": "その他のプロジェクトタブ",
  ...
  "freebuff.engine.title": "エンジン",
  "freebuff.engine.notFound": "FreeBuff Desktopが見つかりません。インストールするかSAIWORK_FREEBUFF_HOMEを設定してください。",
  "freebuff.engine.ready": "準備完了",
  "freebuff.engine.stopped": "停止中",
  "freebuff.engine.start": "エンジンを起動",
  "freebuff.engine.starting": "起動中...",
  "freebuff.quota.exhausted": "使用済み",
  "freebuff.threads.refresh": "更新",
  "freebuff.threads.model": "モデル",
  "freebuff.threads.titleLabel": "タイトル",
  "freebuff.threads.titlePlaceholder": "スレッドのタイトル（任意）",
  "freebuff.threads.none": "まだスレッドがありません。",
  "freebuff.turn.running": "実行中...",
  "freebuff.turn.disabledReason": "現在のターンが終わるまでお待ちください。",
  "freebuff.turn.user": "あなた",
  "freebuff.turn.agent": "エージェント",
  "freebuff.engine.stop": "エンジンを停止",
  "freebuff.quota.title": "日次クォータ",
  "freebuff.quota.tier": "ティア: {tier}",
  "freebuff.quota.resetAt": "{time} にリセット",
  "freebuff.threads.title": "スレッド",
  "freebuff.threads.count": "{count} スレッド",
  "freebuff.threads.new": "新しいスレッド",
  "freebuff.threads.engineNeeded": "FreeBuffを使用するにはエンジンを起動してください。",
  "freebuff.turn.title": "ターン",
  "freebuff.turn.stop": "ターンを停止",
  "freebuff.turn.empty": "まだ出力がありません。",
  "freebuff.turn.composerPlaceholder": "FreeBuffエージェントに指示",
  "freebuff.turn.send": "送信",
  "freebuff.turn.clear": "出力をクリア",
  "freebuff.turn.tool": "ツール",
