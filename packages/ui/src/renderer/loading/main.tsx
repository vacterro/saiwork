...
import iconUrl from "../../images/SaiWork-Icon.png"
  ...
  return (
    <div class="loading-wrapper" role="status" aria-live="polite">
      ...
      <div class="loading-heading">
        <h1 class="loading-title">SAIWORK</h1>
        <Show when={statusKey()}>
      ...
      <div class="loading-card">
        <div class="loading-row">
          {/* Static, not a spinner: UI.md bans motion, and "..." carries the
              same "not dead" signal without an animation frame. */}
