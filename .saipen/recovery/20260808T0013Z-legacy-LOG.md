...
Preserved verbatim during recovery. Entries predate current Event Graph timestamp and single-line requirements.
...
- 08.08.26 [E-030] [parent: E-029] [T-019] DEC: user cleared the first-publish gate -- push branch
  `saiwork` to vacterro/saiwork, and fix the failing test before shipping rather than ship around it
- 08.08.26 [E-031] [T-020] FIX: rewrote the listWorktrees test against a real git repository. The
  old `git.cmd` shim could not be spawned by Node on Windows, so the test passed through the
  "git failed" fallback -- a stub that passes by never running. +1 case for linked worktrees
- 08.08.26 [E-032] [T-019] RUN: node --test server suite -> 267 tests, 263 pass, 0 fail
- 08.08.26 [E-033] [T-019] RUN: npm run test:native electron-app -> 118 tests, 118 pass, 0 fail
- 08.08.26 [E-034] [parent: E-030] [T-019] RUN: ship v0.0.1 -> pushed 05d6e8a5
  (281 files, branch saiwork landed and verified, tag v0.0.1 pushed on the same commit)
