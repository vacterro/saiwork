...
**Version 0.1.0** - a downstream fork based on [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)'s 0.18.0 development commit [`67cb394e`](https://github.com/NeuralNomadsAI/CodeNomad/commit/67cb394e8f38854383bd57a0794274a024ef3d93).
...
Produces `SAIWORK-x64-0.1.0.zip` and the one-file
`SAIWORK-portable-x64-0.1.0.exe` in `packages/electron-app/release/`. The build
